        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between py-5 gap-4">
            ...
            <div className="flex items-center gap-3">
              {/* YouTube */}
              <a href="https://www.youtube.com/@podversal" target="_blank" rel="noopener noreferrer" aria-label="YouTube"
              ...
              {/* Instagram */}
              <a href="https://www.instagram.com/podversal" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
              ...
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/company/podversal" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com/podversal" target="_blank" rel="noopener noreferrer" aria-label="Facebook"
