...
// ── Static data ───────────────────────────────────────
const SERVICES = [
  { icon: Mic,         slug: 'podcast-studio',  title: 'Podcast Studio',  description: 'Multi-channel recording with acoustic treatment, high-end microphones, and professional mixing. Ideal for interview shows and solo episodes.' },
  { icon: Video,       slug: 'vfx-podcast',     title: 'VFX Podcast',     description: 'LED backdrops, live motion graphics, and dynamic visual effects. Your podcast becomes a full video production.' },
  { icon: MonitorPlay, slug: 'monologue-shoot',  title: 'Monologue Shoot', description: 'Teleprompter, three-point lighting, multi-angle setup. Walk in with your script, walk out with broadcast-quality footage.' },
  { icon: Newspaper,   slug: 'news-shoot',       title: 'News Shoot',      description: 'Green screen, anchor desk, broadcast cameras. Designed for news segments, corporate announcements, and media productions.' },
  { icon: Laptop,      slug: 'become-a-podcaster', title: 'Become a Podcaster', description: 'Quiet, controlled environment with teleprompter and screen recording integration. Everything you need to launch and grow your podcast.' },
  { icon: Camera,      slug: 'product-shoots',   title: 'Product Shoots',  description: 'Softboxes, reflectors, controlled colour temperature, multiple backdrop options. For e-commerce, brand campaigns, and product launches.' },
];

const TESTIMONIALS = [
  { name: 'Ankita Ramvir Singh', role: 'Content Creator',          photo: '/ankita.jpg',        quote: 'Booked my first session with zero prior experience — the team made it completely stress-free. Sound quality was better than anything I had recorded before.' },
  { name: 'Devendra Sharma',    role: 'President, Delhi University', photo: '/du-president.jpg',  quote: 'We shot 30 modules over three days. The lighting stayed consistent, the teleprompter saved us hours, and every recording looked broadcast-quality straight out of the studio.' },
  { name: 'Sandeep Verma', role: 'Business Professional',    photo: '/sandeep-verma.jpg', quote: 'Our product launch visuals came out exactly how we imagined them. Professional setup, no guesswork, and the team understood what our brand needed.' },
];

const INVENTORY = [
  { name: 'Sennheiser Profile Microphone', spec: 'Professional condenser — cardioid polar pattern, broadcast-grade preamp', image: '/studio/s3.jpg' },
  { name: 'Sony Alpha ZV-E10',             spec: '4K mirrorless camera · 18-50mm E-mount lens · stabilised footage',       image: '/studio/s5.jpg' },
  { name: 'Digitek Teleprompter',          spec: 'Professional prompter system with wireless tablet control',               image: '/studio/s6.jpg' },
  { name: 'Studio Lighting Rig',           spec: 'Softbox + bi-colour LED panels · broadcast colour calibrated',           image: '/studio/s2.jpg' },
  { name: 'Acoustic Treatment',            spec: 'Full ceiling & wall acoustic panels · isolated recording environment',   image: '/studio/s7.jpg' },
  { name: 'Fluid Head Tripod System',      spec: 'Precision pan/tilt control for cinematic, shake-free camera movement',  image: '/studio/s8.jpg' },
];
              ...
              {SERVICES.map((s, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3 className="font-semibold text-gray-900 dark:text-white mb-2 group-hover:text-[#E5312A] transition-colors">{s.title}</h3>
      ...
      <section className="py-20 bg-[#E5312A]">
        <div className="site-wrap">
          <div ref={whyAnim.ref} className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
            ...
            <div className="grid grid-cols-2 gap-4" style={anim(whyAnim.visible, 0.15)}>
              {[
      ...
      <section className="pt-14 pb-14 bg-white dark:bg-[#111111] overflow-hidden">
        ...
        >
          <div
            ...
            style={{ '--dur': '38s', width: 'max-content' } as React.CSSProperties}
          >
            {[...INVENTORY, ...INVENTORY].map((item, i) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">{item.spec}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-20 bg-[#f8f8f8] dark:bg-[#0e0e0e]">
        <div className="site-wrap">
          <div ref={blogAnim.ref}>
            ...
            {posts.length === 0 ? (
              <div className="text-center py-16 border border-[#e5e5e5] dark:border-[#2a2a2a]" style={anim(blogAnim.visible, 0.1)}>
              ...
              <>
                ...
                <div className="flex sm:hidden justify-center mt-6">
                  <Link href="/blog" className="text-sm font-bold text-[#E5312A]">All Posts</Link>
                </div>
              </>
            )}
          </div>
