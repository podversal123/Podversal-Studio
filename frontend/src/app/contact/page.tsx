            ...
            <div style={slide(ready, 0)}>
              ...
              <div className="grid grid-cols-2 gap-3 mb-5">
                <div className="bg-[#f8f8f8] dark:bg-[#161616] p-4">
                  ...
                  <a
                    href="tel:+917827882058"
                    className="text-sm font-semibold text-gray-900 dark:text-white hover:text-[#E5312A] transition-colors"
                  >
                    +91 78278 82058
                  </a>
                </div>
                ...
                <div className="bg-[#f8f8f8] dark:bg-[#161616] p-4">
                  ...
                  <a
                    href="mailto:Podversalstudio@gmail.com"
                    className="text-sm font-semibold text-gray-900 dark:text-white hover:text-[#E5312A] transition-colors break-all"
                  >
