...
export default function AgentLoginPage() {
  ...
  const handleEmailLogin = async (values: LoginForm) => {
    ...
    try {
      ...
      if (res.data.user.role !== 'REFERRAL_AGENT') {
        toast.error('Access denied. This portal is for Referral Agents only.');
        return;
      }
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f5] dark:bg-[#111111] flex items-center justify-center p-4 relative">
      ...
      <div className="w-full max-w-md">
        ...
        <p className="text-center text-xs font-bold tracking-widest uppercase text-gray-500 dark:text-white mb-3">Agent Portal</p>
