    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <div className="border border-[#e5e5e5] dark:border-[#2a2a2a] text-center py-16">
          ...
          <p className="text-sm text-[#6b6b6b] dark:text-[#8a8a8a]">Click "Add Agent" to onboard a referral agent.</p>
        </div>
      ) : (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-white dark:bg-[#111] border border-[#e5e5e5] dark:border-[#2a2a2a] w-full max-w-lg mx-4 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between px-5 py-4 border-b border-[#e5e5e5] dark:border-[#2a2a2a]">
              <h2 className="text-base font-black text-gray-900 dark:text-white">Add Referral Agent</h2>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="p-5 space-y-4">
              ...
              <div>
                ...
                <input {...register('name')} className="input-field" placeholder="Agent full name" />
              ...
              <div>
                <label className="block text-[10px] font-black tracking-[0.15em] uppercase text-[#6b6b6b] dark:text-[#888] mb-2">Agency / Brand Name *</label>
                <input {...register('agencyName')} className="input-field" placeholder="e.g. XYZ Productions" />
                {errors.agencyName && <p className="text-[#E5312A] text-xs mt-1">{errors.agencyName.message}</p>}
              </div>

              <div>
                <label className="block text-[10px] font-black tracking-[0.15em] uppercase text-[#6b6b6b] dark:text-[#888] mb-2">Commission Rate (%) *</label>
                <input {...register('commissionRate')} type="number" min="0" max="100" step="0.5" className="input-field" placeholder="e.g. 10" />
                {errors.commissionRate && <p className="text-[#E5312A] text-xs mt-1">{errors.commissionRate.message}</p>}
              </div>
