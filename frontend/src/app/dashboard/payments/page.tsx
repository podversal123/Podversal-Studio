              ...
              <select {...register("bookingId")} className="input-field">
                ...
                {bookings.map((b) => (
                  <option key={b.id} value={b.id}>
                    {b.bookingCode} · {b.service?.name ?? "Studio"} ·{" "}
                  ...
                  <tbody className="divide-y divide-[#f0f0f0] dark:divide-[#1e1e1e]">
                    {payments.map((p: any) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          <span
                            className={`text-[10px] font-black tracking-[0.06em] uppercase px-2 py-1 ${p.status === "PAID" ? "bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400" : "bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-400"}`}
                          >
                            {p.status}
                          </span>
                        </td>
