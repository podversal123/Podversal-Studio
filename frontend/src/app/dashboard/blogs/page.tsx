      ...
      {loading ? (
        <div className="space-y-2">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="h-16 bg-[#f5f5f5] dark:bg-[#1a1a1a] animate-pulse"
            />
          ))}
        </div>
      ) : posts.length === 0 ? (
                ...
                {posts.map((post) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 hidden sm:table-cell">
                      <span className="text-[10px] font-black tracking-[0.1em] uppercase text-[#E5312A]">
                        {post.category}
                      </span>
                    </td>
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-1">
                        ...
                        <button
                          ...
                          title="Edit"
                          className="p-1.5 hover:bg-blue-50 dark:hover:bg-blue-900/20 text-blue-600 dark:text-blue-400 transition-colors"
                        >
                          <Edit size={14} />
                        </button>
                        <button
                ...
                <div>
                  ...
                  {form.coverImage && (
                    <img
                      src={form.coverImage}
                      alt="Cover preview"
                      className="mt-2 h-20 w-full object-cover border border-[#e5e5e5] dark:border-[#2a2a2a]"
                      onError={(e) => {
