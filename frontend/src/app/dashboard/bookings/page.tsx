...
function StatusBadge({ status }: { status: BookingStatus }) {
  ...
  return (
    <span
      className={`inline-block px-2.5 py-1 text-[10px] font-black tracking-[0.12em] uppercase ${meta.cls}`}
    >
      {meta.label}
    </span>
  );
                ...
                <tr>
                  <td colSpan={6} className="text-center py-12">
                    ...
                    <button
                      ...
                      className="text-[#E5312A] text-xs mt-2 hover:underline"
                    >
                      Try again
                    </button>
                  </td>
                  ...
                  >
                    ...
                    <td className="px-5 py-4">
                      {b.status === "APPROVED" && !isAdmin ? (
                        <Link
                          href={`/dashboard/bookings/${b.id}`}
                          className="inline-flex items-center gap-1.5 bg-[#E5312A] hover:bg-[#CC2A24] text-white text-xs font-semibold px-3 py-1.5 transition-colors"
                        >
                        ...
                        <Link
                          href={`/dashboard/bookings/${b.id}`}
                          className="text-[#E5312A] hover:underline text-xs font-semibold"
                        >
                          View
                        </Link>
                      )}
