  ...
  const blogs = [
    {
      ...
      tags: ['video podcast', 'personal brand', 'content creation', 'creator economy'],
      coverImage: 'https://images.unsplash.com/photo-1478737270239-2f02b77fc618?w=1200&auto=format&fit=crop&q=80',
      excerpt: 'In 2026, people don\'t just buy products — they buy into the people behind them. Here are five powerful ways a professionally produced video podcast can elevate your personal brand and build lasting audience trust.',
...
<p>Your video podcast library becomes the most comprehensive showcase of your expertise available anywhere online.</p>`,
    ...
    {
      title: 'Audio vs. Video: Why Visual Podcasts on YouTube Outperform Audio-Only in 2026',
      slug: 'audio-vs-video-why-visual-podcasts-outperform-audio-only-2026',
      category: 'Podcasting',
      tags: ['youtube', 'video podcast', 'audio podcast', 'content strategy', '2026'],
      coverImage: 'https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?w=1200&auto=format&fit=crop&q=80',
      excerpt: 'YouTube has officially overtaken traditional audio directories to become the number one platform for podcast consumption globally. If you are still relying solely on audio, your show is invisible to a massive chunk of the market.',
...
<p>Visual podcasts are not a trend — they are the new standard. The question is no longer whether to go visual, but when. The creators and businesses who make this shift now will own significant search and recommendation real estate by the time the rest of the market catches up.</p>`,
    ...
    {
      title: 'How to Structure an Interview Podcast That Keeps Listeners Hooked Past 10 Minutes',
      slug: 'how-to-structure-interview-podcast-keeps-listeners-hooked',
      category: 'Podcasting',
      tags: ['interview podcast', 'podcast structure', 'audience retention', 'content strategy'],
      coverImage: 'https://images.unsplash.com/photo-1590602847861-f357a9332bbc?w=1200&auto=format&fit=crop&q=80',
      excerpt: 'The interview show is one of the most popular podcast formats — and the easiest to get wrong. Here is an intentional, high-engagement structure that retains viewers from the first second to the final frame.',
...
<p>Even a perfectly structured interview can lose an audience if the sound quality is poor or the visuals are distracting. Recording in a professionally treated studio environment ensures that every word lands cleanly — giving your structure the best possible chance of working.</p>`,
    ...
    {
      title: 'One Long-Form Recording, 20 Reels: The Art of Content Repurposing',
      slug: 'one-long-form-recording-20-reels-content-repurposing',
      category: 'Content Strategy',
      tags: ['content repurposing', 'reels', 'short form video', 'creator economy', 'social media'],
      coverImage: 'https://images.unsplash.com/photo-1611532736597-de2d4265fba3?w=1200&auto=format&fit=crop&q=80',
      excerpt: 'The most successful creators don\'t create more content — they maximise what they already have. A single 60-minute studio recording can be transformed into a month\'s worth of high-impact vertical videos.',
...
<p>The entire repurposing strategy only works if the source material is good enough to clip. That starts with the right studio environment.</p>`,
    },
    {
      ...
      category: 'Business',
      tags: ['business podcast', 'content marketing', 'brand authority', 'lead generation', '2026'],
      coverImage: 'https://images.unsplash.com/photo-1543269865-cbf427effbad?w=1200&auto=format&fit=crop&q=80',
      excerpt: 'In 2026, a podcast is no longer just a marketing experiment — it\'s a powerful business asset that builds credibility, strengthens customer relationships, and generates high-quality leads.',
